...
const en = {
  ...
  'softhard.title': 'Soft preference vs Hard reliability', 'softhard.subtitle': 'Each point is one recipe. The frozen formula 0.6·Soft + 0.4·Hard is the iso-score line family.',
  'softhard.xAxis': 'Hard reliability (%)', 'softhard.yAxis': 'Soft preference (%)',
  'softhard.iso': 'iso-score', 'softhard.isoFormula': '0.6S + 0.4H = k',
...
const zh: Record<TranslationKey, string> = {
  ...
  'softhard.title': '软偏好 × 硬可靠性', 'softhard.subtitle': '每个点是一个翻译配方。虚线族为冻结公式 0.6·Soft + 0.4·Hard 的等分线。',
  'softhard.xAxis': '硬可靠性（%）', 'softhard.yAxis': '软偏好（%）',
  'softhard.iso': '等分线', 'softhard.isoFormula': '0.6S + 0.4H = k',
