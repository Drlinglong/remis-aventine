...
const en = {
  ...
  'manifest.eyebrow': 'Published recipe details', 'manifest.zhEnScore': 'ZH–EN score', 'manifest.observedCost': 'Observed cost',
...
const zh: Record<TranslationKey, string> = {
  ...
  'manifest.eyebrow': '已发布翻译配方详情', 'manifest.zhEnScore': '中英得分', 'manifest.observedCost': '实测成本',
