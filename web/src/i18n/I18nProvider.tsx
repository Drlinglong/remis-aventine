...
const en = {
  'nav.overview': 'Overview', 'nav.results': 'ZH–EN Results', 'nav.language': 'Language',
  ...
  'benchmark.current': 'Current benchmark', 'benchmark.title': 'ZH–EN Core Results v0.3', 'benchmark.version': '60% soft preference · 40% hard reliability',
  'benchmark.directions': 'Directions', 'benchmark.contestants': 'Contestants', 'benchmark.softCases': 'Soft cases', 'benchmark.resolved': 'Resolved',
  'benchmark.judges': 'Judges:', 'benchmark.judgeNames': 'Luna + Gemini 3.7 Flash + DeepSeek V4 Flash · family exclusion on',
  'results.badge': 'PUBLISHED · 2 OF 18 DIRECTIONS', 'results.title': 'ZH–EN Core Results v0.3',
  ...
  'results.unavailable': 'ZH–EN v0.3 results are temporarily unavailable.',
  'analysis.title': 'Published v0.3 analysis · ZH–EN only',
  'highlight.score': 'ZH–EN Score', 'highlight.scoreSub': 'Published v0.3 score · Higher is better',
  ...
  'pareto.inspect': 'Hover over points to inspect metrics, or click to open full recipe manifest.', 'pareto.current': 'All values are current published v0.3 measurements.',
  'pareto.open': 'Open recipe manifest.',
  'radar.title': 'Six-axis measured profile', 'radar.subtitle': 'Only published v0.3 measurements are used. Select up to three recipes.',
  'radar.overall': 'Overall', 'radar.soft': 'Soft', 'radar.hard': 'Hard', 'radar.coverage': 'Coverage',
  'manifest.eyebrow': 'Published recipe manifest', 'manifest.zhEnScore': 'ZH–EN score', 'manifest.observedCost': 'Observed cost',
  ...
  'leader.title': 'Published results · ZH–EN Core v0.3', 'leader.scope': 'Officially published scope: zh-CN→en and en→zh-CN.',
  ...
  'footer.status': 'ZH–EN v0.3 · PUBLISHED', 'footer.about': 'A reproducible evaluation ground for translation recipes, born from {remis}. Evaluating complete translation pipelines, not isolated model names.',
  ...
  'footer.copyright': '© 2026 Aventine Project. Released under AGPL-3.0 License. All evaluation artifacts are cryptographic SHA-256 bound.', 'footer.scorePolicy': 'Score Policy:', 'footer.artifact': 'Artifact:',
} as const;

type TranslationKey = keyof typeof en;
const zh: Record<TranslationKey, string> = {
  'nav.overview': '概览', 'nav.results': '中英结果', 'nav.language': '语言',
  ...
  'benchmark.current': '当前基准', 'benchmark.title': '中英核心结果 v0.3', 'benchmark.version': '60% 软偏好 · 40% 硬可靠性',
  'benchmark.directions': '翻译方向', 'benchmark.contestants': '参赛配方', 'benchmark.softCases': '软评测样例', 'benchmark.resolved': '已判定',
  'benchmark.judges': '评审模型：', 'benchmark.judgeNames': 'Luna + Gemini 3.7 Flash + DeepSeek V4 Flash · 已启用模型家族排除',
  'results.badge': '已发布 · 18 个方向中的 2 个', 'results.title': '中英核心结果 v0.3',
  'results.description': 'zh-CN→en 与 en→zh-CN 的正式结果。其余 16 个方向在产生各自的实测结果前暂不展示。',
  'results.unavailable': '中英 v0.3 结果暂时无法加载。',
  'analysis.title': '已发布 v0.3 分析 · 仅中英方向',
  'highlight.score': '中英综合得分', 'highlight.scoreSub': '已发布 v0.3 得分 · 越高越好',
  ...
  'pareto.inspect': '悬停在点位上查看指标，或点击打开完整的公开翻译配方清单。', 'pareto.current': '所有数值均来自当前已发布的 v0.3 实测结果。',
  'pareto.open': '打开翻译配方清单。',
  'radar.title': '六维实测画像', 'radar.subtitle': '仅使用已发布的 v0.3 测量数据；最多选择三个翻译配方。',
  'radar.overall': '综合', 'radar.soft': '软偏好', 'radar.hard': '硬可靠性', 'radar.coverage': '覆盖率',
  'manifest.eyebrow': '已发布翻译配方清单', 'manifest.zhEnScore': '中英得分', 'manifest.observedCost': '实测成本',
  ...
  'leader.title': '已发布结果 · 中英核心 v0.3', 'leader.scope': '正式发布范围：zh-CN→en 与 en→zh-CN。',
  ...
  'footer.status': '中英 v0.3 · 已发布', 'footer.about': '源自 {remis}、面向完整翻译配方的可复现评测场。我们评测完整翻译流水线，而不是孤立的模型名称。',
  ...
  'footer.copyright': '© 2026 Aventine Project。基于 AGPL-3.0 许可证发布。所有评测产物均通过 SHA-256 加密哈希绑定。', 'footer.scorePolicy': '计分策略：', 'footer.artifact': '产物：',
};
